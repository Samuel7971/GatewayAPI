...
using APIProduto.Controllers.Validation;
using APIProduto.Repository;
...
namespace APIProduto
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<DataBaseSettings>(x => Configuration.GetSection("ConnectionString").Bind(x));
